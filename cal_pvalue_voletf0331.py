...
init_df = pd.read_excel(r'C:/Users/Tao/Desktop/投资/HS300/0331/vol数据整理.xlsx', sheet_name=0).iloc[:, :]
#变量太多，不用创业板指
...
df_final.to_csv(r'C:/Users/Tao/Desktop/投资/HS300/vol检查用.csv', index=False, encoding='utf_8_sig')
...
result_df.to_csv(r'C:/Users/Tao/Desktop/投资/HS300/volresult.csv', index=False, encoding='utf_8_sig')
