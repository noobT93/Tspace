...
#主表
final_df = pd.read_excel(r'C:/Users/Tao/Desktop/投资/uvxy/下单模板(p_vol)0331.xlsx',sheet_name = 1)
...
#上证
sh_df = pd.read_excel(r'C:/Users/Tao/Desktop/投资/uvxy/SH.xls')
...
#上证T-2周
try:
    final_df.iloc[2,13] = sh_df1[sh_df1.index == (end - dt.timedelta(days=12))].最低.values
    final_df.iloc[3, 13] = sh_df1[sh_df1.index == (end - dt.timedelta(days=12))].收盘.values
except:
    final_df.iloc[2,13] = sh_df1[sh_df1.index == (end - dt.timedelta(days=19))].最低.values
    final_df.iloc[3, 13] = sh_df1[sh_df1.index == (end - dt.timedelta(days=19))].收盘.values
...
try:
    ...
    final_df.iloc[4, 13] = sh_df1[sh_df1.index == (end - dt.timedelta(days=26))].收盘.values
...
uvxy = web.DataReader('UVXY', 'yahoo',end - dt.timedelta(days=timeend0),end - dt.timedelta(days=1))
...
final_df.iloc[1,3] =uvxy.Low.resample('W', label='right').min().values
final_df.iloc[2,3] =uvxy.Volume.resample('W', label='right').last().values
...
final_df.iloc[4,9] =spx.Volume.resample('W', label='right').last().values
...
final_df.iloc[1,1] =vix.High.resample('W', label='right').max().values
final_df.iloc[3,1] =vix.Low.resample('W', label='right').min().values'''

uvxy = web.DataReader('UVXY', 'yahoo',end - dt.timedelta(days=(timeend0+7)),end - dt.timedelta(days=(timeend0+1)))
'''final_df.iloc[2,3] =uvxy.High.resample('W', label='right').max().values
final_df.iloc[6,3] =uvxy.Low.resample('W', label='right').min().values
final_df.iloc[8,3] =uvxy.Close.resample('W', label='right').last().values'''
high_value = uvxy.High.resample('W', label='right').max().values[0]
final_df.iloc[3,3] =uvxy[uvxy.High == high_value].Volume.values
...
final_df.iloc[4,1] =vix.Low.resample('W', label='right').min().values'''

'''uvxy = web.DataReader('UVXY', 'yahoo',end - dt.timedelta(days=(timeend0+14)),end - dt.timedelta(days=(timeend0+8)))
final_df.iloc[3,3] =uvxy.High.resample('W', label='right').max().values
final_df.iloc[11,3] =uvxy.Volume.resample('W', label='right').last().values'''
...
final_df.iloc[2,7] =ixic.High.resample('W', label='right').max().values
...
high_value = spx.High.resample('W', label='right').max().values[0]
final_df.iloc[9,9] =spx[spx.High == high_value].Volume.values
...
final_df.iloc[1,1] =vix.High.resample('W', label='right').max().values
#final_df.iloc[5,1] =vix.Close.resample('W', label='right').last().values

'''uvxy = web.DataReader('UVXY', 'yahoo',end - dt.timedelta(days=26),end - dt.timedelta(days=20))
final_df.iloc[4,3] =uvxy.High.resample('W', label='right').max().values
final_df.iloc[7,3] =uvxy.Low.resample('W', label='right').min().values
final_df.iloc[12,3] =uvxy.Volume.resample('W', label='right').last().values'''

dji= web.DataReader('^DJI', 'yahoo',end - dt.timedelta(days=(timeend0+21)),end - dt.timedelta(days=(timeend0+15)))
'''final_df.iloc[6,5] =dji.Close.resample('W', label='right').last().values
high_value = dji.High.resample('W', label='right').max().values[0]
