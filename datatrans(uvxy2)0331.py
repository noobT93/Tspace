...
daily_df = pd.read_excel(r'C:/Users/Tao/Desktop/投资/uvxy/0331/日数据.xlsx',sheet_name=1)
trans_df = pd.read_excel(r'C:/Users/Tao/Desktop/投资/uvxy/0331/日转数据.xlsx',sheet_name=1)
...
final_df[['coe','volcoe','slvol']].to_csv(r'C:/Users/Tao/Desktop/投资/uvxy/0331/uvxy系数(分母全部换为下单前一日收盘价）.csv', index=True, encoding='utf_8_sig')

test_df = pd.DataFrame(index = trans_df.iloc[:,0].values,columns = ['coe'])
test_df.iloc[:,0] = tradedf.iloc[:,0].values/trans_df.iloc[:,4].values
test_df.to_csv(r'C:/Users/Tao/Desktop/投资/uvxy/0331/开盘系数(分母全部换为下单前一日收盘价）.csv', index=True, encoding='utf_8_sig')