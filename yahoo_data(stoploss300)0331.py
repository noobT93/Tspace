...
#主表
final_df = pd.read_excel(r'C:/Users/Tao/Desktop/投资/HS300/stoploss300下单模板0331 .xlsx',sheet_name = 1)
...
try:
    ...
    final_df.iloc[2,1] = etf_df1[etf_df1.index == (end - dt.timedelta(days=6))].最低.values
    range_df = etf_df.loc[[datei for datei in etf_df.index if etf_df1.index[-3] < datei < etf_df1.index[-2]], :]
except:
    final_df.iloc[1,1] = etf_df1[etf_df1.index == (end - dt.timedelta(days=13))].最高.values
...
final_df.iloc[7, 1] = range_df[range_df.最高== max(range_df.最高)]['总手(万)'].values
...
final_df.iloc[9, 1] = range_df[range_df.最低== min(range_df.最低)]['总手(万)'].values
final_df.iloc[11, 1] = range_df[range_df.收盘== range_df.收盘[-1]]['总手(万)'].values

#etf T-3周
try:
    final_df.iloc[4, 1] = etf_df1[etf_df1.index == (end - dt.timedelta(days=20))].最低.values
    final_df.iloc[5, 1] = etf_df1[etf_df1.index == (end - dt.timedelta(days=20))].收盘.values
    range_df = etf_df.loc[[datei for datei in etf_df.index if etf_df1.index[-5] < datei < etf_df1.index[-4]], :]
except:
    final_df.iloc[4, 1] = etf_df1[etf_df1.index == (end - dt.timedelta(days=27))].最低.values
    final_df.iloc[5, 1] = etf_df1[etf_df1.index == (end - dt.timedelta(days=27))].收盘.values
...
try:
    ...
    final_df.iloc[4,3] = sh_df1[sh_df1.index == (end - dt.timedelta(days=6))].收盘.values
    ...
    final_df.iloc[4,3] = sh_df1[sh_df1.index == (end - dt.timedelta(days=13))].收盘.values
...
try:
    ...
    final_df.iloc[5, 3] = sh_df1[sh_df1.index == (end - dt.timedelta(days=20))].收盘.values
    ...
    final_df.iloc[5, 3] = sh_df1[sh_df1.index == (end - dt.timedelta(days=27))].收盘.values
...
final_df.iloc[9, 5] = range_df[range_df.最低== min(range_df.最低)]['总手(万)'].values
...
final_df.iloc[5,7] =hsi.Volume.resample('W', label='right').last().values
...
final_df.iloc[5,9] =dji.Volume.resample('W', label='right').last().values
...
final_df.iloc[6,11] =ixic.Volume.resample('W', label='right').last().values
...
final_df.iloc[7,13] =spx.Volume.resample('W', label='right').last().values
...
final_df.iloc[4,7] =hsi.Close.resample('W', label='right').last().values
high_value = hsi.High.resample('W', label='right').max().values[0]
final_df.iloc[6,7] =hsi[hsi.High == high_value].Volume.values
...
final_df.iloc[6,9] =dji[dji.High == high_value].Volume.values
...
final_df.iloc[9,11] =ixic[ixic.Low == low_value].Volume.values
final_df.iloc[11,11] =ixic.Volume.resample('W', label='right').last().values
...
final_df.iloc[8,13] =spx[spx.High == high_value].Volume.values
final_df.iloc[10,13] =spx.Volume.resample('W', label='right').last().values
...
final_df.iloc[2,9] =dji.High.resample('W', label='right').max().values
final_df.iloc[3,9] =dji.Close.resample('W', label='right').last().values
high_value = dji.High.resample('W', label='right').max().values[0]
...
final_df.iloc[2,11] =ixic.Low.resample('W', label='right').min().values
...
final_df.iloc[3,13] =spx.High.resample('W', label='right').max().values
final_df.iloc[4,13] =spx.Low.resample('W', label='right').min().values
final_df.iloc[6,13] =spx.Close.resample('W', label='right').last().values
low_value = spx.Low.resample('W', label='right').min().values[0]
final_df.iloc[9,13] =spx[spx.Low == low_value].Volume.values
final_df.iloc[11,13] =spx.Volume.resample('W', label='right').last().values
...
final_df.iloc[7,7] =hsi.Volume.resample('W', label='right').last().values
#high_value = hsi.High.resample('W', label='right').max().values[0]
...
final_df.iloc[4,9] =dji.Close.resample('W', label='right').last().values
low_value = dji.Low.resample('W', label='right').min().values[0]
final_df.iloc[8,9] =dji[dji.Low == low_value].Volume.values
final_df.iloc[10,9] =dji.Volume.resample('W', label='right').last().values

ixic= web.DataReader('^IXIC', 'yahoo',end - dt.timedelta(days=27),end - dt.timedelta(days=21))
final_df.iloc[3,11] =ixic.Low.resample('W', label='right').min().values
final_df.iloc[5,11] =ixic.Close.resample('W', label='right').last().values
high_value = ixic.High.resample('W', label='right').max().values[0]
final_df.iloc[8,11] =ixic[ixic.High == high_value].Volume.values
low_value = ixic.Low.resample('W', label='right').min().values[0]
final_df.iloc[10,11] =ixic[ixic.Low == low_value].Volume.values

spx= web.DataReader('^GSPC', 'yahoo',end - dt.timedelta(days=27),end - dt.timedelta(days=21))
final_df.iloc[5,13] = spx.Low.resample('W', label='right').min().values
#low_value = spx['Low'].resample('W', label='right').min().values[0]
