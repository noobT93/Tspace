...
#主表
final_df = pd.read_excel(r'C:/Users/Tao/Desktop/投资/spy/stoploss下单模板0331.xlsx',sheet_name = 1)
...
try:
    ...
    final_df.iloc[4,13] = sh_df1[sh_df1.index == (end + dt.timedelta(days=2))].最低.values
    ...
    final_df.iloc[4,13] = sh_df1[sh_df1.index == (end - dt.timedelta(days=5))].最低.values
    range_df = sh_df.loc[[datei for datei in sh_df.index if sh_df1.index[-3] < datei < sh_df1.index[-1]], :]

final_df.iloc[9, 13] = range_df[range_df.收盘== range_df.收盘[-1]]['总手(万)'].values

#上证T-1周
try:
    final_df.iloc[5,13] = sh_df1[sh_df1.index == (end - dt.timedelta(days=5))].最低.values
    final_df.iloc[6,13] = sh_df1[sh_df1.index == (end - dt.timedelta(days=5))].收盘.values
    range_df = sh_df.loc[[datei for datei in sh_df.index if sh_df1.index[-3] < datei < sh_df1.index[-2]], :]
except:
    final_df.iloc[5,13] = sh_df1[sh_df1.index == (end - dt.timedelta(days=12))].最低.values
    final_df.iloc[6,13] = sh_df1[sh_df1.index == (end - dt.timedelta(days=12))].收盘.values
    range_df = sh_df.loc[[datei for datei in sh_df.index if sh_df1.index[-4] < datei < sh_df1.index[-2]], :]

final_df.iloc[13, 13] = range_df[range_df.收盘== range_df.收盘[-1]]['总手(万)'].values

#上证T-2周
try:
    final_df.iloc[2,13] = sh_df1[sh_df1.index == (end - dt.timedelta(days=12))].最高.values
    final_df.iloc[7, 13] = sh_df1[sh_df1.index == (end - dt.timedelta(days=12))].收盘.values
    range_df = sh_df.loc[[datei for datei in sh_df.index if sh_df1.index[-3] < datei < sh_df1.index[-2]], :]
except:
    final_df.iloc[2,13] = sh_df1[sh_df1.index == (end - dt.timedelta(days=19))].最高.values
    final_df.iloc[7, 13] = sh_df1[sh_df1.index == (end - dt.timedelta(days=19))].收盘.values
    range_df = sh_df.loc[[datei for datei in sh_df.index if sh_df1.index[-3] < datei < sh_df1.index[-2]], :]

final_df.iloc[10, 13] = range_df[range_df.最高== max(range_df.最高)]['总手(万)'].values

#上证T-3周
try:
    final_df.iloc[3, 13] = sh_df1[sh_df1.index == (end - dt.timedelta(days=19))].最高.values
    final_df.iloc[8, 13] = sh_df1[sh_df1.index == (end - dt.timedelta(days=19))].收盘.values
    range_df = sh_df.loc[[datei for datei in sh_df.index if sh_df1.index[-5] < datei < sh_df1.index[-4]], :]
except:
    final_df.iloc[3, 13] = sh_df1[sh_df1.index == (end - dt.timedelta(days=26))].最高.values
    final_df.iloc[8, 13] = sh_df1[sh_df1.index == (end - dt.timedelta(days=26))].收盘.values
    range_df = sh_df.loc[[datei for datei in sh_df.index if sh_df1.index[-6] < datei < sh_df1.index[-4]], :]

final_df.iloc[11, 13] = range_df[range_df.最高== max(range_df.最高)]['总手(万)'].values
final_df.iloc[12, 13] = range_df[range_df.最低== min(range_df.最低)]['总手(万)'].values
...
final_df.iloc[6,1] =spy.Volume.resample('W', label='right').last().values
...
final_df.iloc[8,1] =spy[spy.Low == low_value].Volume.values
...
final_df.iloc[4,3] =vix.Close.resample('W', label='right').last().values'''
...
final_df.iloc[9,9] =spx[spx.Low == low_value].Volume.values
...
final_df.iloc[9,11] =hsi.Volume.resample('W', label='right').last().values
'''high_value = hsi.High.resample('W', label='right').max().values[0]
final_df.iloc[6,11] =hsi[hsi.High == high_value].Volume.values'''
...
final_df.iloc[9,1] =spy.Volume.resample('W', label='right').last().values
'''low_value = spy.Low.resample('W', label='right').min().values[0]
final_df.iloc[6,1] =spy[spy.Low == low_value].Volume.values'''

vix= web.DataReader('^VIX', 'yahoo',end - dt.timedelta(days=(timeend0+14)),end - dt.timedelta(days=(timeend0+8)))
final_df.iloc[3,3] =vix.Close.resample('W', label='right').last().values
...
final_df.iloc[5,5] =dji[dji.High == high_value].Volume.values'''
low_value = dji.Low.resample('W', label='right').min().values[0]
final_df.iloc[8,5] =dji[dji.Low == low_value].Volume.values
final_df.iloc[10,5] =dji.Volume.resample('W', label='right').last().values

ixic= web.DataReader('^IXIC', 'yahoo',end - dt.timedelta(days=(timeend0+14)),end - dt.timedelta(days=(timeend0+8)))
final_df.iloc[3,7] =ixic.Low.resample('W', label='right').min().values
...
high_value = spx.High.resample('W', label='right').max().values[0]
final_df.iloc[7,9] =spx[spx.High == high_value].Volume.values
...
final_df.iloc[8,11] =hsi[hsi.Low == low_value].Volume.values
#final_df.iloc[10,11] =hsi.Volume.resample('W', label='right').last().values
...
final_df.iloc[5,1] =spy.Close.resample('W', label='right').last().values
high_value = spy.High.resample('W', label='right').max().values[0]
final_df.iloc[7,1] =spy[spy.High == high_value].Volume.values
...
final_df.iloc[2,3] =vix.High.resample('W', label='right').max().values
...
final_df.iloc[2,5] =dji.High.resample('W', label='right').max().values
high_value = dji.High.resample('W', label='right').max().values[0]
final_df.iloc[6,5] =dji[dji.High == high_value].Volume.values
low_value = dji.Low.resample('W', label='right').min().values[0]
final_df.iloc[9,5] =dji[dji.Low == low_value].Volume.values
final_df.iloc[11,5] =dji.Volume.resample('W', label='right').last().values
...
final_df.iloc[8,7] =ixic.Volume.resample('W', label='right').last().values'''
...
final_df.iloc[8,9] =spx[spx.High == high_value].Volume.values
low_value = spx.Low.resample('W', label='right').min().values[0]
final_df.iloc[10,9] =spx[spx.Low == low_value].Volume.values
final_df.iloc[11,9] =spx.Volume.resample('W', label='right').last().values
...
final_df.iloc[6,11] =hsi.Close.resample('W', label='right').last().values
'''high_value = hsi.High.resample('W', label='right').max().values[0]
final_df.iloc[8,11] =hsi[hsi.High == high_value].Volume.values
low_value = hsi.Low.resample('W', label='right').min().values[0]
final_df.iloc[9,11] =hsi[hsi.Low == low_value].Volume.values
