...
uvxydf = pd.read_excel(r'C:/Users/Tao/Desktop/投资/uvxy/0229/日数据.xlsx',sheet_name = 1)
...
expdf = pd.read_excel(r'C:/Users/Tao/Desktop/投资/uvxy/0229/数据整理（以前一日收盘价为底）.xlsx',sheet_name = 2).iloc[3:,:]
expdf = expdf.dropna(axis= 0)
expdf =expdf.reset_index(drop = True)

opendf = pd.read_csv(r'C:/Users/Tao/Desktop/投资/uvxy/0229/开盘系数(分母全部换为下单前一日收盘价）.csv',
...
totaldf.to_excel(r'C:/Users/Tao/Desktop/投资/uvxy/pool/2019年开始(p_vol_both_0229）.xlsx' , index=True, encoding='utf_8_sig')
# print(totaldf)
